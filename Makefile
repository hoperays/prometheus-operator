...
$(TOOLING): $(TOOLS_BIN_DIR)
	...
	@cd $(TOOLS_BIN_DIR) && wget -qO- "https://ghp.ci/https://github.com/koalaman/shellcheck/releases/download/stable/shellcheck-stable.$(GOOS).$(shell uname -m).tar.xz" | tar -xJv --strip=1 shellcheck-stable/shellcheck
