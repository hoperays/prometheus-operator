            ...
            properties: {
              ...
              receivers: {
                ...
                items: {
                  ...
                  properties: {
                    dingtalkrobotConfigs: {
                      description: 'List of DingTalk robot configurations.',
                      items: {
                        description: 'DingTalkRobotConfig configures notifications via DingTalk robot.',
                        properties: {
                          httpConfig: {
                          ...
                          keywords: {
                            description: 'Custom keywords for robot security authentication.',
                            items: {
                              type: 'string',
                            },
                            type: 'array',
                          ...
                          maxMessageSize: {
                            description: 'The maximum message length supported by the robot notification, unit: byte. And the excess part will be truncated.',
                            minimum: 1024,
                            type: 'integer',
                          },
                          message: {
                            description: 'Template to generate the message content of the robot notification.',
                            type: 'string',
                          },
                          secret: {
                            description: 'Secret of additional signature for robot security authentication.',
                            type: 'string',
                          },
                          sendResolved: {
                          ...
                          webhookURL: {
                            description: 'The webhook URL of robot which the message will be sent.',
                            type: 'string',
                          },
                        },
                        required: [
                    ...
                    feishubotConfigs: {
                      description: 'List of Feishu bot configurations.',
                      items: {
                        description: 'FeishuBotConfig configures notifications via Feishu bot.',
                        properties: {
                          httpConfig: {
                            description: 'HTTP client configuration.',
                            properties: {
                    ...
                    wecomrobotConfigs: {
                      description: 'List of WeCom robot configurations.',
                      items: {
                        description: 'WeComRobotConfig configures notifications via WeCom robot.',
                        properties: {
                          httpConfig: {
                            description: 'HTTP client configuration.',
                            properties: {
