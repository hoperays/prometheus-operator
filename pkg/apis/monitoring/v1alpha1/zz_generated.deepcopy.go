...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DingTalkRobotConfig) DeepCopyInto(out *DingTalkRobotConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DingTalkRobotConfig.
func (in *DingTalkRobotConfig) DeepCopy() *DingTalkRobotConfig {
	if in == nil {
		return nil
	}
	out := new(DingTalkRobotConfig)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeishuBotConfig) DeepCopyInto(out *FeishuBotConfig) {
	*out = *in
	if in.SendResolved != nil {
		in, out := &in.SendResolved, &out.SendResolved
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeishuBotConfig.
func (in *FeishuBotConfig) DeepCopy() *FeishuBotConfig {
	if in == nil {
		return nil
	}
	out := new(FeishuBotConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Receiver) DeepCopyInto(out *Receiver) {
	*out = *in
	...
	if in.WeComRobotConfigs != nil {
		in, out := &in.WeComRobotConfigs, &out.WeComRobotConfigs
		*out = make([]WeComRobotConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DingTalkRobotConfigs != nil {
		in, out := &in.DingTalkRobotConfigs, &out.DingTalkRobotConfigs
		*out = make([]DingTalkRobotConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.FeishuBotConfigs != nil {
		in, out := &in.FeishuBotConfigs, &out.FeishuBotConfigs
		*out = make([]FeishuBotConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WeComRobotConfig) DeepCopyInto(out *WeComRobotConfig) {
	*out = *in
	if in.SendResolved != nil {
		in, out := &in.SendResolved, &out.SendResolved
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WeComRobotConfig.
func (in *WeComRobotConfig) DeepCopy() *WeComRobotConfig {
	if in == nil {
		return nil
	}
	out := new(WeComRobotConfig)
	in.DeepCopyInto(out)
	return out
}
